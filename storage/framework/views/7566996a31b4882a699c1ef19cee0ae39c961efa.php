		...
		<div class="columns is-mobile is-justify-content-center">
			<div class="column is-flex-grow-0 is-10-mobile is-5-tablet is-4-desktop is-3-widescreen is-3-fullhd">
				...
				<div class="has-text-centered">
					...
					<form action="<?php echo e(route('login.user')); ?>" id="sendOtp" method="post">
					<?php echo csrf_field(); ?>
						<!--Step 1-->
						<div class="section-mobile">
							<div class="mt-6">
								<h5 class="title is-6">Please provide your phone number without +<?php echo e($_ENV['MOBILE_EXTENSION']); ?></h5>
							</div>
							<div class="mt-4">
...
<?php echo $__env->make('layouts.new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dvgsaeae/teacher.dvgsoft.com/resources/views/auth/login.blade.php ENDPATH**/ ?>