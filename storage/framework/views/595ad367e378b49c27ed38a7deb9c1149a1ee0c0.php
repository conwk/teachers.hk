		...
		<div class="columns is-mobile is-justify-content-center">
			<div class="column is-flex-grow-0 is-10-mobile is-5-tablet is-4-desktop is-3-widescreen is-3-fullhd">			
				<form action="<?php echo e(route('edit_profile.update')); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="my-3">
						...
						<div class="radio-group">
							<div class="form-check form-switch">
							 <input class="form-check-input" name="edit_url" type="checkbox" id="switch_status" <?php echo e(($user->edit_url == 1)?"checked":""); ?> style="margin-top:8px;">
							 <label for="switch_status">Make Profile Active?</label>							 
							 </div>
							<!--<input required type="radio" name="edit_url" value="1" id="edit_url_yes" <?php echo e((isset($user->edit_url) && $user->edit_url == '1') ? 'checked' : ''); ?> />&nbsp;<label for="edit_url_yes">Yes</label>
							<input required type="radio" name="edit_url" value="0" id="edit_url_no" <?php echo e((isset($user->edit_url) && $user->edit_url == '0') ? 'checked' : ''); ?>  />&nbsp;<label for="edit_url_no">No</label>-->
						</div>
						<div class="edit-url-section" style="display:none;">
							<label class="profile-url"><?php echo e(Str::limit($profileUrl, 35)); ?>

							<i link-url="<?php echo e($profileUrl); ?>" title="Click to edit URL" class="fas fa-edit edit-profile-url" aria-hidden="true" style="color:#333; padding-left:10px; padding-top:3px; font-size:16px; cursor:pointer;"></i>
							<i link-url="<?php echo e($profileUrl); ?>" id="clipboard-btn" title="Copied!" class="fas fa-clipboard copy" aria-hidden="true" data-toggle="tooltip" data-placement="top" style="color:#333; padding-left:10px; padding-top:3px; font-size:16px; cursor:pointer;"></i>
							</label>
							<div class="profile-url-group" style="display:none;">
								<label class="url-label" ><?php echo e(Str::limit($profileUrl, 20)); ?></label>
								<input style="margin-top:5px;" name="new_profile_id" id="new_profile_id" class="is-primary custom-input" type="text" placeholder="Enter profile url" maxLength="30" value="<?php echo e(isset($user->profile_id) ? $user->profile_id : old('profile_id')); ?>" />
							</div>
					...
					<div class="my-3">
						<input required name="first_name" class="input is-primary" type="text" placeholder="Full name as per HKID" value="<?php echo e(isset($user->first_name) ? $user->first_name : old('first_name')); ?>">
					</div>
					...
					<div class="my-3">
						<input required name="address" class="input is-primary" type="text" placeholder="Address" value="<?php echo e(isset($user->address) ? $user->address : old('address')); ?>">
					</div>
					<div class="my-3">
						<div class="field">
							<p class="control has-icons-left has-icons-right">
								<input required name="email" class="input is-primary" type="email" placeholder="Email" value="<?php echo e(isset($user->email) ? $user->email : old('email')); ?>">
					...
					<div class="my-3">
						<input required name="dob" class="input  is-primary" type="date" placeholder="Date of Birth" value="<?php echo e(isset($user->dob) ? $user->dob : old('dob')); ?>">
					</div>
					<div class="is-block dropdown accountTypeOption">
					 ...
					 <div class="mt-3 is-block dropdown preferredMathodOption">
						<div class="is-fullwidth dropdown-trigger">
							<input type="hidden" name="pref_contact_method" id="user-pref_contact_method" value="<?php echo e(isset($user->pref_contact_method) ? ucfirst($user->pref_contact_method) : old('pref_contact_method')); ?>" />
					...
					<div class="my-3 profile-picture is-relative">
						<div class="has-text-centered">
							<div class="img">
								...
								<a class="remove-photo" data-image="<?php echo e($user->photo); ?>" href="javascript:void(0);"><i class="fas fa-times"></i></a>	
								<img class="profile-pic image-crop upload-button" src="<?= URL::to('/'); ?>/frontend/teacher/<?php echo e($user->photo); ?>">
								<?php else: ?>
					...
					<div class="mb-5">
						...
						<div class="my-3">
							<input required name="social_links[twitter]" id="basic-url" type="url" class="input is-primary" placeholder="https://www.twitter.com" value="<?php echo e(isset($socialLinks->twitter) ? $socialLinks->twitter : old('social_links[twitter]')); ?>"  >
						</div>
					</div>
					<div class="mb-5">
					
						<div class="my-3">
							<input required name="social_links[linkedin]" id="basic-url" type="url" class="input is-primary" placeholder="https://www.linkedin.com" value="<?php echo e(isset($socialLinks->linkedin) ? $socialLinks->linkedin : old('social_links[linkedin]')); ?>" >
						</div>
					</div>
					<div class="mb-5">
						
						<div class="my-3">
							<input required name="social_links[instagram]" id="basic-url" type="url" class="input is-primary" placeholder="https://www.instagram.com" value="<?php echo e(isset($socialLinks->instagram) ? $socialLinks->instagram : old('social_links[instagram]')); ?>">
						</div>
					</div>
					
					<div class="my-3">
						<textarea required name="about_us" id="about-us" class="textarea is-primary"  placeholder="About you" row="8"><?php echo e(isset($user->about_us) ? $user->about_us : old('about_us')); ?></textarea>
					</div>				   
					<div class="mt-3">
...
<!-- crop  -->
  ...
  <script src="<?= URL::to('/'); ?>/frontend/js/script.js?t=<?php echo e(time()); ?>"></script>
...
<?php echo $__env->make('layouts.new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dvgsaeae/teacher.dvgsoft.com/resources/views/edit_profile.blade.php ENDPATH**/ ?>