  ...
  <span class="badge badge-danger navbar-badge">3</span>
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="<?= URL::to('/'); ?>/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                                Nora Silvester
...
<!-- /.navbar --><?php /**PATH /home/dvgsaeae/teacher.dvgsoft.com/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>