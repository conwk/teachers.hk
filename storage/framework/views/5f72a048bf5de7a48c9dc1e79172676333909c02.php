                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('login.custom')); ?>"><?php echo e(__('Login')); ?></a>
                            </li>
...
</html><?php /**PATH F:\XAMPP\htdocs\teacher\resources\views/layouts/app.blade.php ENDPATH**/ ?>