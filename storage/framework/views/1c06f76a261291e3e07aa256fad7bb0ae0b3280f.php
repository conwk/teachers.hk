          ...
          <?php echo $user->about_us ?>
           ...
           <div class="my-6">
            ...
            <a href="<?php echo e(route('post.view',$post->slug)); ?>" class="linkCourses">
                <div class="my-5">
                <p class="title is-5 has-text-left m-0" style="white-space: pre-wrap;"><?php echo e($post->title); ?></p> 
                <p class="mt-1 subtitle is-6 m-0"><?php echo e($post->subtitle); ?></p>
