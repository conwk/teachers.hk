...
<!-- The Modal -->
	<div id="myModal" class="modal">
	  ...
	  <div class="modal-content">
		...
		<div class="box">
			<form action="{{route('contact.contact_post')}}" id="sendBtn" method="post">
             @csrf
			...
			<div class="field my-5">
				<div class="control">
				<input id="type" type="hidden" class="form-control" value="{{$post->title}}" name="type" required autofocus>
				<input id="profile_id" type="hidden" class="form-control" value="{{$post->user_id}}" name="user_id" required autofocus>
