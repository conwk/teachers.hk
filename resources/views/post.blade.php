	...
	@endif
	 <div class="columns is-mobiler">
            ...
            <a href="{{ route('post.view',$post->slug) }}" class="linkCourses">
                <div class="my-5">
                <p class="title is-5 has-text-left m-0" style="white-space: pre-wrap;color:#BD3F39; font-size:18px; font-weight:bold; line-height:28px;display: flex;">{{ucfirst($post->title)}} 
				<?php 
					if($post->status == 1){
