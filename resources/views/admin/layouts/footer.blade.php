...
<!-- AdminLTE DataTable -->
<script src="{{ asset('/admin/dist/js/datatable/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('/admin/dist/js/datatable/dataTables.bootstrap4.min.js') }}"></script>
<script src="{{ asset('/admin/dist/js/datatable/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset('/admin/dist/js/datatable/buttons.bootstrap4.min.js') }}"></script>
