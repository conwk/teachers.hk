...
?>
	...
	{!! Form::open(['route' => 'users.add','novalidate' => 'novalidate', 'files' => true]) !!}
	<div class="card-body">
		<div class="row"> 
			<div class="col-md-12">         
			...
			<div class="col-md-4">         
				<div class="form-group">
					...
					{{Form:: text('comapny_name','',['class'=>'form-control' , 'autocomplete'=>'off'])}}
			...
			<div class="col-md-4">         
				<div class="form-group">
					...
					{{Form:: text('mobile_num','',['class'=>'form-control' , 'autocomplete'=>'off'])}}
			...
			<div class="col-md-4">         
				<div class="form-group">
					...
					{{Form:: text('whatsapp_number','',['class'=>'form-control' , 'autocomplete'=>'off'])}}
		...
		<div class="row">
			...
			<div class="col-md-12">         
				<div class="form-group">
					...
					{{Form:: text('full_address','',['class'=>'form-control' , 'autocomplete'=>'off'])}}
			...
			<div class="col-md-12">         
				<div class="form-group">
					...
					{{Form:: text('gst_number','',['class'=>'form-control' , 'autocomplete'=>'off'])}}
