...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
		...
		<?php if(isset($page) && $page == 'post'): ?>
			...
			<link rel="stylesheet" href="{{ asset('/frontend/css/amsify.suggestags.css') }}" />
			<script src="{{ asset('/frontend/js/jquery.amsify.suggestags.js') }}"></script>
		<?php else: ?>
			<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
		<?php endif; ?>		
		<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.min.js" ></script>
		<!--<script src="{{ asset('/frontend/js/bootstrap-tagsinput.js') }}" defer></script>-->
      ...
      <div class="is-widescreen body-menu is-relative">
          <aside class=" menu-d menu" >
            ...
            <ul class="menu-list">
              ...
              <li class="is-relative" >	<form action="{{ route('signOut') }}" method="POST">
												@csrf
