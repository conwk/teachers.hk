        ...
        <div class="columns is-mobile is-justify-content-center">
            <div class="column is-flex-grow-0 is-10-mobile is-5-tablet is-4-desktop is-3-widescreen is-3-fullhd">
                <form action="{{ route('post.update') }}" method="POST" >
                    ...
                    <div class="my-3">
                        <input name="title" class="input is-primary" type="text" value="{{ $post->title }}" placeholder="Your Post Title" required />
                    </div>
                      <div class="my-3">					             
                        <input name="subtitle" class="input is-primary" type="text" value="{{ $post->subtitle }}" placeholder="Your Subtitle Title" style="display:none;" />
                    </div>
                    <div class="my-3">
                        <input name="tags" class="input is-primary" type="text" value="{{ $post->tags }}" placeholder="Add Keyword For better search" />
                    </div>
                    ...
                    <div class="my-3">
                        <input name="teaching_place" class="input is-primary" type="text" value="{{ $post->teaching_place }}"  placeholder="Preferred Place of teaching"  />
                    </div>
                    ...
                    <div class="my-3">
                        <textarea id="post-content" required name="content"  class="textarea is-primary" placeholder="About the Course" row="8">{{ $post->content }}</textarea>
                    </div>
