            ...
            <div class="column is-flex-grow-0 is-10-mobile is-5-tablet is-4-desktop is-3-widescreen is-3-fullhd">
                <form action="{{ route('post.update') }}" method="POST" >
                    ...
                    <div class="my-3">
                      ...
                      <div class="my-3">
                        <input name="subtitle" class="input is-primary" type="text" placeholder="Your Subtitle Title" style="display:none" />
                    </div>
                    <div class="my-3">
                        <input name="tags" class="input is-primary" type="text" placeholder="Add Keyword For better search" />
						<!--<input name="tags" class="input is-primary" type="text" placeholder="Add Keyword For better search" data-role="tagsinput" />-->
                    </div>
